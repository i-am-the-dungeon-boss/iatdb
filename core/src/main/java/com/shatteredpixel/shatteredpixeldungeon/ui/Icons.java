...
public enum Icons {
	...
	// misc larger icons, mainly used for buttons, tabs, and journal, spacing for
	// 16x16
	TARGET,
	INFO,
	WARNING,
	...
	LOST,
	INVESTIGATE,
	DEPTH, // depth icons have three variants, for regular, seeded, daily, and daily replay
			// runs
	DEPTH_CHASM,
	DEPTH_WATER,
	DEPTH_GRASS,
		...
		switch (type) {
			...
			case IATDB:
				icon.frame(icon.texture.uvRectBySize(
						IatdbIconFrame.X, IatdbIconFrame.Y,
						IatdbIconFrame.WIDTH, IatdbIconFrame.HEIGHT));
				break;
	...
	public static Image get(HeroClass cl) {
		switch (cl) {
			...
			case MAGE:
				// mage's staff normally has 2 pixels extra at the top for particle effects, we
				// chop that off here
