...
public class v0_3_X_Changes {
	...
	public static void add_v0_3_1_Changes(ArrayList<ChangeInfo> changeInfos) {
		...
		changes.addButton(
				new ChangeButton(new Image(Assets.Environment.TERRAIN_FEATURES, 112, 96, 16, 16), "Trap Overhaul",
		...
		changes.addButton(
				new ChangeButton(new Image(Assets.Interfaces.MENU_BTN_TINTED, 15, 0, 16, 15), "Interface Improvements",
