...
public class Ring extends KindofMisc {
	...
	/** Initializes gems only when unset — never wipe mid-run knowledge. */
	public static void ensureGems() {
		if (handler == null) {
			initGems();
		}
	}
	...
	// useful for items that appear in UIs, or which are only spawned for their
	// effects
