...
public class Flail extends MeleeWeapon {
	...
	protected boolean duelistAbility(UseContext ctx, Integer target) {
		...
		SpinAbilityTracker spin = kit.buff(SpinAbilityTracker.class);
		...
		if (spin == null) {
			spin = Buff.affect(kit, SpinAbilityTracker.class, 3f);
		}

		spin.spins++;
		Buff.prolong(kit, SpinAbilityTracker.class, 3f);
