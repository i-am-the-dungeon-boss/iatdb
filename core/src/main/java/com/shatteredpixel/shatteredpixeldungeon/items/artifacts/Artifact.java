...
public class Artifact extends KindofMisc {
	...
	// level is used internally to track upgrades to artifacts, size/logic varies
	// per artifact.
	...
	// used by some artifacts to keep track of duration of effects or cooldowns to
	// use.
	...
	/** Fills the artifact charge pool to cap (no-op when unused). */
	...
	/**
	 * True when this artifact does not spend charge, or has at least one charge
	 * left. Used by echo policy inventory readiness.
	 */
	public boolean hasCharges() {
		return chargeCap <= 0 || charge > 0;
	}
