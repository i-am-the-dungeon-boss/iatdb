...
public class WandOfCorruption extends Wand {
	...
	// This is because the wand of corruption considers them to be a certain level
	// of harmful
	// for the purposes of reducing resistance, but does not actually apply them
	// itself
	...
	public void onZap(Ballistica bolt) {
		...
		if (ch != null) {
			...
			// base enemy resistance is usually based on their exp, but in special cases it
			...
			if (ch instanceof Mimic || ch instanceof Statue) {
				...
				// divide by 5 as wraiths are always at full HP and are therefore ~5x harder to
				// corrupt
	...
	private void corruptEnemy(Mob enemy) {
		// cannot re-corrupt or doom an enemy, so give them a major debuff instead
		if (enemy.buff(Corruption.class) != null || enemy.buff(Doom.class) != null) {
			GLog.wIfHero(curUser, Messages.get(this, "already_corrupted"));
			return;
		}
