...
import com.shatteredpixel.shatteredpixeldungeon.levels.rooms.sewerboss.EchoBossRoom;
...
public class EchoBossLevel extends SewerLevel {
    ...
    public void create() {
        super.create();
        if (Dungeon.getPendingEcho() != null) {
    ...
    protected ArrayList<Room> initRooms() {
        ...
        EchoBossRoom bossRoom = new EchoBossRoom();
